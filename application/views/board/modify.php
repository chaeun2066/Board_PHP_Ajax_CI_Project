...
<body>
    <div class="col-md-8 mt-2" style="margin:auto;padding:20px;">
        <div class="wrap">
            <h3 class="pb-4 mb-4 font-weight-bold border-bottom" style="text-align: center;"> - 게시판 수정 - </h3>
...
?>
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" name="content" class="form-control" id="content" rows="10"><?= $view->content;?></textarea>
                </div>
                <div class="text-lg-end">
                    <button type="submit" id="update" class="btn btn-primary mt-2" style="">등록</button>
                </div>
            </form>
        </div>
    </div>
